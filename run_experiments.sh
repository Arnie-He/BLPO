...
algorithms=("stac-actor" "actor_critic" )
...
actor_learning_rates=(0.003)
critic_learning_rates=(0.008)
                    ...
                    for nystrom_rank in "${nystrom_ranks[@]}"; do
                        for nystrom_rho in "${nystrom_rhos[@]}"; do
                            for seed in "${seeds[@]}"; do
                                ...
                                description="_seed${seed}_actorlr${actor_lr}_criticlr${critic_lr}_nested${nested_updates}_adv${adv_rate}_nystromrank${nystrom_rank}_nystromrho${nystrom_rho}"
